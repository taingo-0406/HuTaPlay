...
const ImgUpload = ({ onChange, src } /*#__PURE__*/) =>
  React.createElement(
    "label",
    {
    ...
    React.createElement(
      "div",
      { className: "img-wrap img-upload" } /*#__PURE__*/,
...
const Name = ({ onChange, value } /*#__PURE__*/) =>
  React.createElement(
    "div",
...
const Status = ({ onChange, value } /*#__PURE__*/) =>
  React.createElement(
    "div",
    { className: "field" } /*#__PURE__*/,
    React.createElement(
...
const Profile = ({ onSubmit, src, name, status } /*#__PURE__*/) =>
  React.createElement(
    "div",
    ...
    React.createElement(
      ...
      React.createElement(
        "label",
        { className: "custom-file-upload fas" } /*#__PURE__*/,
        React.createElement(
          "div",
...
const Edit = ({ onSubmit, children } /*#__PURE__*/) =>
  React.createElement(
    "div",
    { className: "card" } /*#__PURE__*/,
    React.createElement(
...
class CardProfile extends React.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "editName", (e) => {
...
ReactDOM.render(
  /*#__PURE__*/ React.createElement(CardProfile, null),
