                ...
                <form id="edit-stage">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="toh-discs" required />
                        </div>
                        <div class="form-group">
                            <label>Memory Game Size</label>
                            <input type="text" class="form-control" name="memory-size" required />
                        </div>
                        <div class="form-group">
                            <label>Optimal Points</label>
                            <input type="text" class="form-control" name="optimal-points" required />
                        </div>
                    </div>
