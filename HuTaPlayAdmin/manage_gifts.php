...
<head>
    ...
    <script src="js/manage_gifts.js"></script>
            ...
            <div class="modal-content">
                <form id="add-gift">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>Display</label>
                            <input type="number" class="form-control" name="display" required>
                        </div>
                    </div>
